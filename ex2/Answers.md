...
אתחלנו את מטריצת הפליטה בהסתברות אחידה (0.5 בכל הערכים). כתוצאה מכך, במטריצת הפליטה הנלמדת קיבלנו שבהינתן כל מצב חבוי, ההסתברות ללמוד את אותה תצפית זהה. כלומר, במקרה שלנו:
$P(H | F) = P(H | L), P(T | F) = P(T | L)$
